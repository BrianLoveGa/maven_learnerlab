...
public class TestPeople {
    ...
    @Test
        ...
        Person personToAdd1 = new Person(9L, "steve");
        Assert.assertFalse(people.contains(personToAdd1));

        // when
        people.add(personToAdd1);
        // then
        Assert.assertTrue(people.contains(personToAdd1));
